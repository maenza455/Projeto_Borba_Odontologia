...
@WebServlet("/CadastroServlet") // Mapeamento do servlet
public class CadastroServlet extends HttpServlet
{
            ...
            throws ServletException, IOException
    {
        ...
        String nome = request.getParameter("IDUSUARIO");
        String email = request.getParameter("email");
        String password = request.getParameter("password"); // Captura a senha
        String date = request.getParameter("date"); // Captura a data
        ...
        try
        {
            ...
            if (conn != null)
            {
                ...
                String sql = "INSERT INTO ATENDIODONTO (Nome, Email, senha, Data_nascimento) VALUES (?, ?, ?, ?)";
